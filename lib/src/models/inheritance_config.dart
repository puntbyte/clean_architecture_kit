// lib/src/config/models/inheritance_config.dart
...
class InheritanceConfig {
  ...
  factory InheritanceConfig.fromMap(Map<String, dynamic> map) {
    return InheritanceConfig(
      ...
      repositoryBaseName: map['repository_base_name'] as String?
          ?? _CoreDefaults.repositoryBaseName,
      ...
      nullaryUseCaseName: map['nullary_use_case_name'] as String?
          ?? _CoreDefaults.nullaryUseCaseName,
    );
  }
}
